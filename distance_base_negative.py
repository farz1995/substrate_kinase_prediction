...
if __name__ == '__main__':
    ...
    main_model_name = "facebook/esm2_t12_35M_UR50D"  # Example model, change as needed
    main_tokenizer = EsmTokenizer.from_pretrained(main_model_name)
    main_model = EsmModel.from_pretrained(main_model_name).cuda()

    data_path = "kinase_data/positive_new_train_all_columns_cdhit_0.7_kinase_domain.csv"
